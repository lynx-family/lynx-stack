---
applyTo: "packages/web-platform/web-elements/src/elements/ScrollView/**,packages/web-platform/web-elements/src/elements/htmlTemplates.ts,packages/web-platform/web-elements/src/template.rs,packages/web-platform/web-core/package.json,packages/web-platform/web-core/README.md,packages/web-platform/web-core/ts/client/plugins/**"
---
...
Expose optional web-elements plugins through matching `@lynx-js/web-core/plugins/*` entry points that import the web-elements implementation. Keep them separate from `@lynx-js/web-core/client` so the behavior remains opt-in.
