...
Keep v1.0 support additive to v0.9. Expand inline createSurface initialization through the existing component/data handlers, preserve the incoming version on streamed loading placeholders and snapshots, and apply the same source validation to inline components as updateComponents. Reject duplicate creation before expanding its embedded updates.
