...
If you want to treat other CSS files as CSS Modules as well, you can achieve this by configuring [output.cssModules.auto](/rspeedy/config/output#output-cssmodules-auto).
...
You can disable CSS minification by setting [`output.minify.css`](/rspeedy/config/output#output-minify) to `false`.
