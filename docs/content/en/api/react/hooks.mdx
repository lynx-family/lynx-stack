...
**Returns:** [`InitData`](/api/react/types#initdata)
...
| --- | --- | --- |
| `callback` | `(data: `[`InitData`](/api/react/types#initdata)`) => void` |  |
...
**Returns:** [`GlobalProps`](/api/react/types#globalprops)
...
| Parameters | Type | Description |
| --- | --- | --- |
| `callback` | `(data: `[`GlobalProps`](/api/react/types#globalprops)`) => void` |  |
...
**Returns:** [`MainThreadRef`](/api/react/types#mainthreadref)`<T>`
