...
Should be used with `lynx.registerDataProcessors`. See more examples at [`Lynx.registerDataProcessors`](#lynx-registerdataprocessors).
...
:::warning Deprecated
use [`lynx.registerDataProcessors`](#lynx-registerdataprocessors) instead
:::
...
The data processors that registered with [`Lynx.registerDataProcessors`](#lynx-registerdataprocessors).
...
| Members | Type | Description |
| --- | --- | --- |
| <a id="dataprocessordefinition-dataprocessors"></a>`dataProcessors?` | [`DataProcessors`](#dataprocessors) | Should be used with `lynx.registerDataProcessors`. See more examples at [`Lynx.registerDataProcessors`](#lynx-registerdataprocessors). |
| <a id="dataprocessordefinition-defaultdataprocessor"></a>`defaultDataProcessor?` | `(rawInitData: `[`InitDataRaw`](#initdataraw)`) => `[`InitData`](#initdata) | You can custom input and output type of `defaultDataProcessor` by extends [`InitDataRaw`](#initdataraw) and [`InitData`](#initdata) Should be used with `lynx.registerDataProcessors`. See more examples at [`Lynx.registerDataProcessors`](#lynx-registerdataprocessors). |
