...
通过 **Import Attributes** 显式声明某些模块可以在主线程和后台线程之间共享。仅用于使用 **[主线程函数（Main Thread Function）](https://lynxjs.org/zh/react/main-thread-script)** 的场景。详情请参考[跨线程共享模块](https://lynxjs.org/zh/react/main-thread-script#跨线程共享模块)。
