...
export const PACKAGES: PackageEntry[] = [
  ...
  },
  {
    id: 'genui-a2ui',
    dir: 'packages/genui',
    entry: 'a2ui/src/index.ts',
    tsconfig: 'a2ui/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/a2ui',
  ...
  },
  {
    id: 'genui-openui',
    dir: 'packages/genui',
    entry: 'openui/src/core/index.ts',
    tsconfig: 'openui/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/openui',
    name: '@lynx-js/genui/openui',
    includeExternals: true,
  },
  {
    id: 'genui-openui-explicit',
    dir: 'packages/genui',
    entry: 'openui/src/core/explicit.ts',
    tsconfig: 'openui/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/openui-explicit',
    name: '@lynx-js/genui/openui/explicit',
  },
  {
    id: 'genui-openui-prompt',
    dir: 'packages/genui',
    entry: 'openui/src/openui-prompt/index.ts',
    tsconfig: 'openui/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/openui-prompt',
    name: '@lynx-js/genui/openui/prompt',
  },
  {
    id: 'genui-a2ui-prompt',
    dir: 'packages/genui',
    entry: 'a2ui-prompt/src/index.ts',
    tsconfig: 'a2ui-prompt/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/a2ui-prompt',
    name: '@lynx-js/genui/a2ui-prompt',
  },
  {
    id: 'genui-a2ui-catalog-extractor',
    dir: 'packages/genui',
    entry: 'a2ui-catalog-extractor/src/index.ts',
    tsconfig: 'a2ui-catalog-extractor/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/a2ui-catalog-extractor',
    name: '@lynx-js/genui/a2ui-catalog-extractor',
  },
  {
    id: 'genui-lynx-xml',
    dir: 'packages/genui',
    entry: 'lynx-xml/src/index.ts',
    tsconfig: 'lynx-xml/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/lynx-xml',
    name: '@lynx-js/genui/lynx-xml',
  },
  {
    id: 'genui-mcp-apps',
    dir: 'packages/genui',
    entry: 'mcp-apps/src/index.ts',
    tsconfig: 'mcp-apps/tsconfig.build.json',
    group: 'libraries',
    page: '/api/genui/mcp-apps',
    name: '@lynx-js/genui/mcp-apps',
  },
  {
