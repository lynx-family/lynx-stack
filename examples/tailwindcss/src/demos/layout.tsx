...
function OverflowAxisBox(
  ...
  return (
    <view className='w-[48%] flex flex-col gap-[4px] overflow-visible'>
      <text className='text-content-muted text-xs'>{label}</text>
      <view
        className={`relative w-full h-[64px] rounded-[12px] bg-neutral-ambient ${className}`}
      >
        <view className='absolute left-[28px] top-[14px] w-[150px] h-[20px] rounded-full bg-primary' />
        <view className='absolute left-[42px] top-[28px] w-[40px] h-[72px] rounded-[12px] bg-primary-muted' />
      </view>
    </view>
  );
}
...
export function LayoutDemo() {
  return (
    <view className='w-full flex flex-col gap-[12px]'>
      ...
      <DemoCell label='overflow-x-hidden overflow-x-visible'>
        <view className='w-full flex flex-row justify-between overflow-visible pb-[40px]'>
          <OverflowAxisBox
            label='x-hidden'
        ...
        <text className='text-content-subtle text-xs'>
          Pink horizontal bar tests x; pale vertical bar should still overflow.
        </text>
      </DemoCell>

      <DemoCell label='overflow-y-hidden overflow-y-visible'>
        <view className='w-full flex flex-row justify-between overflow-visible pb-[40px]'>
          <OverflowAxisBox
            label='y-hidden'
        ...
        <text className='text-content-subtle text-xs'>
          Pale vertical bar tests y; pink horizontal bar should still overflow.
        </text>
      </DemoCell>
