...
const LIBRARY_FEATURE_HINTS: Record<LibraryFeature, string> = {
  'native-module':
    'JS bridge APIs for Android, iOS, and Harmony platform targets',
  'napi-native-module': 'shared C++ N-API native module generated from typings',
  element:
    'native UI element for Android, iOS, Harmony, and shared C++ targets',
...
const LIBRARY_PLATFORM_HINTS: Record<LibraryPlatform, string> = {
  ...
  harmony: 'Harmony HAR source directory and global Autolink provider',
...
Library features:
  native-module                JS bridge APIs for Android, iOS, and Harmony platform targets.
  napi-native-module           Shared C++ N-API native module generated from typings.
  element                      Native UI element for Android, iOS, Harmony, and shared C++ targets.
  service                      Native service implementation registered globally.

Native platforms:
  android                      Android native source directory and manifest entry.
  ios                          iOS native source directory and podspec.
  harmony                      Harmony HAR and global Autolink provider.
  lynxtron                     Shared C++ sources and Node-API loader for Lynxtron.
