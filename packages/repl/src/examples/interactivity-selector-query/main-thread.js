...
globalThis.renderPage = function renderPage() {
  ...
  __SetInlineStyles(box, "width:200px; height:100px; background-color:#22c55e; border-radius:12px; margin-top:20px; align-items:center; justify-content:center;");
  ...
  __SetInlineStyles(resultText, "font-size:12px; font-family:monospace; color:#555; margin-top:16px;");
