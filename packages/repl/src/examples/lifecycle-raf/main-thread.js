...
globalThis.renderPage = function renderPage() {
  ...
  __SetInlineStyles(bar, "width:20px; height:20px; background-color:#3b82f6; border-radius:10px; margin-top:24px;");
  ...
  __SetInlineStyles(frameInfo, "font-size:12px; font-family:monospace; color:#666; margin-top:16px;");
  ...
  function animate() {
    ...
    __SetInlineStyles(bar, "width:" + width + "px; height:20px; background-color:#3b82f6; border-radius:10px; margin-top:24px;");
