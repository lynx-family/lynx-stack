...
__SetInlineStyles(view, "display:flex; align-items:center; justify-content:center; height:100%; flex-direction:column; background-color:#f0fdf4;");
__SetInlineStyles(label, "font-size:16px; color:#666;");
__SetInlineStyles(counter, "font-size:48px; font-weight:700; color:#16a34a; margin-top:8px;");
