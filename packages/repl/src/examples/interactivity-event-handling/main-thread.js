...
globalThis.renderPage = function renderPage() {
  ...
  __SetInlineStyles(outer, "padding:20px; background-color:#eff6ff; border-radius:12px; align-items:center;");
  ...
  __SetInlineStyles(outerLabel, "font-size:12px; color:#3b82f6; margin-bottom:12px;");
  ...
  __SetInlineStyles(inner, "padding:12px 24px; background-color:#3b82f6; border-radius:8px;");
  ...
  __SetInlineStyles(sibling, "padding:12px 24px; background-color:#dbeafe; border-radius:8px; margin-top:8px;");
  ...
  __SetInlineStyles(siblingLabel, "color:#1e40af; font-size:14px; font-weight:600;");
