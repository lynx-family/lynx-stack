...
//
// The background thread uses the standard Fetch API (available in
// Web Workers) to load remote data, then sends it to the main
// thread for rendering via cross-thread events.
...
globalThis.renderPage = function renderPage() {
  ...
  __SetInlineStyles(resultBox, "margin-top:12px; background-color:#f1f5f9; padding:16px; border-radius:8px; width:280px;");
  ...
  __SetInlineStyles(resultText, "font-size:12px; font-family:monospace; color:#333;");
