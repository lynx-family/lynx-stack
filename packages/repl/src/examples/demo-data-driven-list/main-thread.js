...
globalThis.renderPage = function renderPage() {
  ...
  __SetInlineStyles(container, "display:flex; flex-direction:column; align-items:center; padding-top:60px; height:100%; background-color:#eff6ff;");
  ...
  lynx.getJSContext().addEventListener("addItem", (event) => {
    ...
    __SetInlineStyles(row, "background-color:#dbeafe; padding:10px 16px; border-radius:8px; margin-top:8px;");
