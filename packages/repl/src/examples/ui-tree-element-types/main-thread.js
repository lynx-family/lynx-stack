...
globalThis.renderPage = function renderPage() {
  ...
  __SetInlineStyles(viewLabel, "font-size:14px; font-weight:600; margin-top:20px;");
  ...
  for (let i = 1; i <= 3; i++) {
    ...
    __SetInlineStyles(child, "width:50px; height:50px; background-color:#3b82f6; border-radius:6px; align-items:center; justify-content:center;");
  ...
  __SetInlineStyles(textLabel, "font-size:14px; font-weight:600; margin-top:20px;");

  const styles = [
    { text: "Bold 20px", style: "font-size:20px; font-weight:700; color:#111;" },
    { text: "Italic purple", style: "font-size:16px; font-style:italic; color:#9333ea;" },
    { text: "Monospace small", style: "font-size:12px; font-family:monospace; color:#666;" },
  ];
  ...
  __SetInlineStyles(imgLabel, "font-size:14px; font-weight:600; margin-top:20px;");

  const imgRow = __CreateView(0);
  __AppendElement(container, imgRow);
  __SetInlineStyles(imgRow, "flex-direction:row; margin-top:8px; align-items:center;");
  ...
  __AppendElement(imgDesc, __CreateRawText('src="https://lynxjs.org/img/lynx-logo.svg"'));
  __SetInlineStyles(imgDesc, "font-size:11px; font-family:monospace; color:#666; margin-left:12px;");
