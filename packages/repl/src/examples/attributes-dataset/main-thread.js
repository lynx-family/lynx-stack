...
globalThis.renderPage = function renderPage() {
  ...
  for (let i = 0; i < items.length; i++) {
    ...
    __SetInlineStyles(row, "padding:12px; background-color:#f8fafc; border-radius:6px; margin-top:8px;");
  ...
  for (let i = 0; i < elements.length; i++) {
    ...
    __SetInlineStyles(t, "font-size:11px; font-family:monospace; margin-top:4px;");
  }
