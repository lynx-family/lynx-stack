...
globalThis.renderPage = function renderPage() {
  ...
  for (const tag of tags) {
    ...
    __SetInlineStyles(el, "padding:8px; margin-top:4px; background-color:#f0f0f0; border-radius:4px;");
    if (tag === "text") {
  ...
  function addLine(str) {
    ...
    __SetInlineStyles(t, "font-size:13px; font-family:monospace; margin-top:4px;");
  }
