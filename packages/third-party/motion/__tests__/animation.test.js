...
describe('motion wrapping animation functions', () => {
    ...
    beforeEach(() => {
        ...
        vi.spyOn(globalThis, 'runOnRegistered', 'get').mockImplementation(function (id) {
    ...
    test('motion animate should be called', async () => {
        ...
        const App = () => {
            ...
            return (_jsx("view", { children: _jsx("view", { "main-thread:ref": boxMTRef }) }));
        };
        await act(() => {
            render(_jsx(App, {}), {
        ...
        expect(_mockAnimate).toHaveBeenCalledWith(expect.anything(), // the element
