...
use self::{
  attr_name::AttrName,
  jsx_helpers::{
    is_sdk_version_ge_3_1, jsx_attr_name, jsx_attr_to_prop, jsx_attr_value, jsx_children_to_expr,
  ...
  V: VisitMut,
{
  fn visit_mut_jsx_element(&mut self, n: &mut JSXElement) {
    ...
    if !jsx_is_custom(n) {
      ...
      let is_ge_3_1 = is_sdk_version_ge_3_1(&self.cfg.target_sdk_version);
