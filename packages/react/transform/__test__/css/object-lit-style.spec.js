...
describe.skip('Parse Object Literal Style', () => {
  it('should parse object literal style', () => {
  ...
  it('should parse object literal style with different cases', () => {
    const result = transformReactLynx(
  ...
  it('should parse object literal style with in order', () => {
    const result = transformReactLynx(
  ...
  it('should parse object literal style with multiple elements', () => {
    const result = transformReactLynx(
      `\
  <view style={{ 'flex': 'column', flexShrink: 1, 'flex': 'line' }}>
  ...
  it('should parse object literal style with exprs as value (dynamic value < static value)', () => {
    const result = transformReactLynx(
      `\
  ...
  it('should parse object literal style with identifier as value shorthand', () => {
    const result = transformReactLynx(
      `\
  let width = f();
  let height = '100px';
  ...
  it('should fallback to SetInlineStyles when have computed CSS property', () => {
    const result = transformReactLynx(
