...
describe('jsx', () => {
  ...
  it('<list-item defer item-key="1" />', async () => {
    ...
    expect(result).toMatchInlineSnapshot(`
      ...
      const __snapshot_da39a_efa563d7_2 = /*#__PURE__*/ ReactLynx.createSnapshot("__snapshot_da39a_efa563d7_2", function() {
          const pageId = ReactLynx.__pageId;
      ...
      const __snapshot_da39a_efa563d7_1 = /*#__PURE__*/ ReactLynx.createSnapshot("__snapshot_da39a_efa563d7_1", function(snapshotInstance) {
          const pageId = ReactLynx.__pageId;
  ...
  it('should not warn JSXSpread when not enable addComponentElement', async () => {
...

    {
      ...
      expect(result.code).toMatchInlineSnapshot(`
        ...
        const __snapshot_2d408_4da58493_1 = /*#__PURE__*/ ReactLynx.createSnapshot("__snapshot_2d408_4da58493_1", function() {
            const pageId = ReactLynx.__pageId;
            const el = __CreateView(pageId);
            return [
                el
        ...
        /*#__PURE__*/ ReactLynx1.wrapWithLynxComponent((__c, __spread)=>/*#__PURE__*/ _jsx(__snapshot_2d408_4da58493_1, {
                values: [
                    {
                        ...__spread,
                        __spread: true
...
`,
    ...
    expect(result.code).toMatchInlineSnapshot(`
      ...
      import * as ReactLynx from "@lynx-js/react";
      let c = 1;
      const __snapshot_2d408_fdcd539e_1 = /*#__PURE__*/ ReactLynx.createSnapshot("__snapshot_2d408_fdcd539e_1", function() {
          const pageId = ReactLynx.__pageId;
          const el = __CreateView(pageId);
          return [
              el
      ...
      export default class App extends Component {
          a() {}
          render() {
              return /*#__PURE__*/ _jsx(__snapshot_2d408_fdcd539e_1, {});
          }
          state = ((()=>{
              if (!__LEPUS__) this.a();
          })(), {
...
`,
    ...
    expect(
      ...
      "import { jsx as _jsx } from "@lynx-js/react/jsx-runtime";
      import * as ReactLynx from "@lynx-js/react";
      const __snapshot_2d408_6525c76e_1 = /*#__PURE__*/ ReactLynx.createSnapshot("__snapshot_2d408_6525c76e_1", function() {
          const pageId = ReactLynx.__pageId;
          const el = __CreateView(pageId);
          return [
              el
      ...
      class X extends Component {
          constructor(){}
          render() {
              return /*#__PURE__*/ _jsx(__snapshot_2d408_6525c76e_1, {});
          }
      }
      /*#__PURE__*/ _jsx(X, {});
      "
      ...
      if (target === 'LEPUS') {
        expect(code).toMatchInlineSnapshot(`
          ...
          export let getCurrentDelta = {
              ...
              _wkltId: "2d40:b88d3c29:1"
          };
          loadWorkletRuntime(typeof globDynamicComponentEntry === 'undefined' ? undefined : globDynamicComponentEntry) && registerWorkletInternal("main-thread", "2d40:b88d3c29:1", function(event) {
              const getCurrentDelta = lynxWorkletImpl._workletMap["2d40:b88d3c29:1"].bind(this);
              let { foo } = this["_c"];
              "main thread";
              return foo.bar.baz;
          });
...
`,
    ...
    expect(code).toMatchInlineSnapshot(`
      ...
      export let foo = {
          ...
          _wkltId: "2d40:21759364:1"
      };
      loadWorkletRuntime(typeof globDynamicComponentEntry === 'undefined' ? undefined : globDynamicComponentEntry) && registerWorkletInternal("main-thread", "2d40:21759364:1", function(event) {
          const foo = lynxWorkletImpl._workletMap["2d40:21759364:1"].bind(this);
          let { bar, qux } = this["_c"];
          "main thread";
          return bar.baz['qux'] || bar.qux['baz'] || qux.bar.baz;
      });
...
`,
    ...
    expect(code).toMatchInlineSnapshot(`
      ...
      var loadWorkletRuntime = __loadWorkletRuntime;
      let foo = {
          _wkltId: "2d40:2ec866b7:1"
      };
      let bar = {
          _c: {
              foo
          },
          _wkltId: "2d40:2ec866b7:2"
      };
      console.log(bar);
      loadWorkletRuntime(typeof globDynamicComponentEntry === 'undefined' ? undefined : globDynamicComponentEntry) && registerWorkletInternal("main-thread", "2d40:2ec866b7:1", function() {
          const foo = lynxWorkletImpl._workletMap["2d40:2ec866b7:1"].bind(this);
          "main thread";
          return null;
      });
      loadWorkletRuntime(typeof globDynamicComponentEntry === 'undefined' ? undefined : globDynamicComponentEntry) && registerWorkletInternal("main-thread", "2d40:2ec866b7:2", function() {
          const bar = lynxWorkletImpl._workletMap["2d40:2ec866b7:2"].bind(this);
          let { foo } = this["_c"];
          "main thread";
          foo();
      });
...
`,
    ...
    expect(code).toMatchInlineSnapshot(`
      "import { loadWorkletRuntime as __loadWorkletRuntime } from "@lynx-js/react";
      var loadWorkletRuntime = __loadWorkletRuntime;
      loadWorkletRuntime(typeof globDynamicComponentEntry === 'undefined' ? undefined : globDynamicComponentEntry) && registerWorkletInternal("main-thread", "2d40:b69521f0:1", function(event) {
          lynxWorkletImpl._workletMap["2d40:b69521f0:1"].bind(this);
          let { foo, a, b } = this["_c"];
          "main thread";
          if (foo(a)) foo(b);
          return null;
