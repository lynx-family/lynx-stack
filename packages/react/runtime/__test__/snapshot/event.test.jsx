        ...
        [
          [
            "rLynxFirstScreen",
            {
              ...
              "root": "{"id":-7,"type":"root","children":[{"id":-8,"type":"__Card__:__snapshot_05fe4_test_12","children":[{"id":-9,"type":"__Card__:__snapshot_05fe4_test_11","values":["-9:0:"]}]}]}",
            },
          ],
        ]
      `);
      ...
      expect(delayedLifecycleEvents).toMatchInlineSnapshot(`
        [
          [
            ...
            {
              "jsReadyEventIdSwap": {},
              "root": "{"id":-1,"type":"root","children":[{"id":-2,"type":"__Card__:__snapshot_05fe4_test_14","children":[{"id":-3,"type":"__Card__:__snapshot_05fe4_test_13","values":["-3:0:"]}]}]}",
            },
          ],
        ]
      `);
