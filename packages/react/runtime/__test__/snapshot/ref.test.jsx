...
describe('element ref', () => {
      ...
      expect(globalThis.__OnLifecycleEvent.mock.calls[0]).toMatchInlineSnapshot(`
        [
          [
            ...
            {
              "jsReadyEventIdSwap": {},
              "root": "{"id":-1,"type":"root","children":[{"id":-2,"type":"__Card__:__snapshot_da39a_test_3","values":["react-ref--2-0","react-ref--2-1"]}]}",
            },
          ],
        ]
      `);
  ...
  it('should trigger ref when insert node', async function() {
    ...
    // insert node
    {
      ...
      expect(lynx.getNativeApp().callLepusMethod.mock.calls[0][1].data).toMatchInlineSnapshot(
        `"{"patchList":[{"id":3,"snapshotPatch":[0,"__Card__:__snapshot_da39a_test_4",2,4,2,[1,1],1,-1,2,null]}]}"`,
      );
    }
      ...
      expect(globalThis.__OnLifecycleEvent.mock.calls[0]).toMatchInlineSnapshot(`
        [
          [
            ...
            {
              "jsReadyEventIdSwap": {},
              "root": "{"id":-1,"type":"root","children":[{"id":-2,"type":"__Card__:__snapshot_da39a_test_9","values":["react-ref--2-0","react-ref--2-1","react-ref--2-2"]}]}",
            },
          ],
        ]
      `);
  ...
  it('should trigger ref when element not exists in the first screen', async function() {
      ...
      expect(globalThis.__OnLifecycleEvent.mock.calls[0]).toMatchInlineSnapshot(`
        [
          [
            ...
            {
              "jsReadyEventIdSwap": {},
              "root": "{"id":-1,"type":"root","children":[{"id":-2,"type":"__Card__:__snapshot_da39a_test_17"}]}",
            },
          ],
        ]
      `);
    ...
    // hydrate
    {
      ...
      expect(lynx.getNativeApp().callLepusMethod).toHaveBeenCalledTimes(1);
      expect(lynx.getNativeApp().callLepusMethod.mock.calls[0][1].data).toMatchInlineSnapshot(
        `"{"patchList":[{"snapshotPatch":[0,"__Card__:__snapshot_da39a_test_18",3,4,3,[1],1,-2,3,null],"id":2}]}"`,
      );
        ...
        [
          [
            [
              ...
              {
                "jsReadyEventIdSwap": {},
                "root": "{"id":-1,"type":"root","children":[{"id":-2,"type":"__Card__:__snapshot_da39a_test_19","values":[{},{"ref":"react-ref--2-1"},{}]}]}",
              },
            ],
          ],
        ]
...
describe('ui operations', () => {
  ...
  it('should not delay after hydration', async function() {
    ...
    // set show
    {
      ...
      expect(lynx.getNativeApp().callLepusMethod.mock.calls[0][1].data).toMatchInlineSnapshot(
        `"{"patchList":[{"id":3,"snapshotPatch":[0,"__Card__:__snapshot_da39a_test_30",3,4,3,[1],1,-2,3,null]}]}"`,
      );
      expect(lynx.createSelectorQuery().constructor.execLog.mock.calls).toMatchInlineSnapshot(`
        [
          [
