    ...
    expect(JSON.parse(ssrEncode())).toMatchInlineSnapshot(`
      {
        "__opcodes": [
          ...
          0,
          [
            "__Card__:__snapshot_da39a_test_5",
            -5,
            [
              {
                "ssrID": 675,
    ...
    expect(JSON.parse(ssrEncode())).toMatchInlineSnapshot(`
      {
        "__opcodes": [
          0,
          [
            "__Card__:__snapshot_da39a_test_6",
            -2,
            [
              {
                "ssrID": 681,
    ...
    expect(JSON.parse(ssrEncode())).toMatchInlineSnapshot(`
      {
        "__opcodes": [
          0,
          [
            "__Card__:__snapshot_da39a_test_7",
            -2,
            [
              {
                "ssrID": 683,
    ...
    expect(JSON.parse(ssrEncode())).toMatchInlineSnapshot(`
      {
        "__opcodes": [
          0,
          [
            "__Card__:__snapshot_da39a_test_8",
            -2,
            [
              {
                "ssrID": 685,
          ...
          0,
          [
            "__Card__:__snapshot_da39a_test_9",
            -3,
            [
              {
                "ssrID": 686,
