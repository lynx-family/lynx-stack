...
describe('printSnapshotInstance', () => {
  ...
  it('basic', async function() {
    ...
    expect(msg).toMatchInlineSnapshot(`
      "
      | 1(__Card__:__snapshot_05fe4_test_1): undefined
        | 2(__Card__:__snapshot_05fe4_test_2): undefined
          | 4(__Card__:__snapshot_05fe4_test_3): ["attr 1","attr 2"]
        | 3(__Card__:__snapshot_05fe4_test_2): undefined
      "
    `);
  });
