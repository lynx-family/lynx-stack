...
describe('document - background', () => {
  ...
  it('basic - diff', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_14
          0="world"
        >
          "Hello"
        </__Card__:__snapshot_da39a_test_14>
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_15>
          <__Card__:__snapshot_da39a_test_16>
            "Hello"
          </__Card__:__snapshot_da39a_test_16>
          <__Card__:__snapshot_da39a_test_17>
            "World"
          </__Card__:__snapshot_da39a_test_17>
        </__Card__:__snapshot_da39a_test_15>
      </root>
  ...
  it('basic - update raw-text', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_18>
          "Hello!"
        </__Card__:__snapshot_da39a_test_18>
      </root>
    `);
  ...
  it('basic - update removeAttribute', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_25
          0="Hello"
        />
      </root>
    `);
  ...
  it('lazy', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_27>
          "foo"
        </__Card__:__snapshot_da39a_test_27>
      </root>
    `);
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_26
          0="bar"
        />
      </root>
    `);
...
describe('document - dual-runtime', () => {
  it('should work with hydrate', () => {
    ...
    expect(backgroundRoot).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_29>
          <__Card__:__snapshot_da39a_test_30>
            "W"
          </__Card__:__snapshot_da39a_test_30>
          <__Card__:__snapshot_da39a_test_30>
            "0"
  ...
  it('should not emit patch about `undefined` not being `null`', () => {
    ...
    expect(backgroundRoot).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_da39a_test_31 />
      </root>
    `);
    delete BackgroundSnapshotInstance.prototype.toJSON;
