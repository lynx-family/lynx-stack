...
describe('document - background', () => {
  ...
  it('basic - diff', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_13
          0="world"
        >
          "Hello"
        </__Card__:__snapshot_05fe4_test_13>
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_14>
          <__Card__:__snapshot_05fe4_test_15>
            "Hello"
          </__Card__:__snapshot_05fe4_test_15>
          <__Card__:__snapshot_05fe4_test_16>
            "World"
          </__Card__:__snapshot_05fe4_test_16>
        </__Card__:__snapshot_05fe4_test_14>
      </root>
  ...
  it('basic - update raw-text', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_17>
          "Hello!"
        </__Card__:__snapshot_05fe4_test_17>
      </root>
    `);
  ...
  it('basic - update removeAttribute', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_22
          0="Hello"
        />
      </root>
    `);
  ...
  it('lazy', async function() {
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_24>
          "foo"
        </__Card__:__snapshot_05fe4_test_24>
      </root>
    `);
    ...
    expect(scratch).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_23
          0="bar"
        />
      </root>
    `);
...
describe('document - dual-runtime', () => {
  it('should work with hydrate', () => {
    ...
    expect(backgroundRoot).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_26>
          <__Card__:__snapshot_05fe4_test_27>
            "W"
          </__Card__:__snapshot_05fe4_test_27>
          <__Card__:__snapshot_05fe4_test_27>
            "0"
  ...
  it('should not emit patch about `undefined` not being `null`', () => {
    ...
    expect(backgroundRoot).toMatchInlineSnapshot(`
      <root>
        <__Card__:__snapshot_05fe4_test_28 />
      </root>
    `);
    delete BackgroundSnapshotInstance.prototype.toJSON;
