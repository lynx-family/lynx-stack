...
describe('setState timing api', () => {
  it('basic', async function() {
    ...
    expect(mtCallbacks[0][1]).toMatchInlineSnapshot(`
      {
        "data": "{"patchList":[{"id":3,"snapshotPatch":[0,"__snapshot_a94a8_test_2",3,0,null,4,3,4,0,1,1,3,4,null,null,1,-2,3,null,null]}],"flushOptions":{"__lynx_timing_flag":"__lynx_timing_actual_fmp"}}",
        "patchOptions": {
          "flowIds": [
            666,
          ],
...
describe('attribute timing api', () => {
  it('basic', async function() {
    ...
    expect(mtCallbacks[0][1]).toMatchInlineSnapshot(`
      {
        "data": "{"patchList":[{"id":6,"snapshotPatch":[0,"__snapshot_a94a8_test_4",3,4,3,[{"__ltf":"__lynx_timing_actual_fmp"}],0,null,4,3,4,0,1,1,3,4,null,null,1,-2,3,null,null]}]}",
        "patchOptions": {
          "flowIds": [
            666,
          ],
  ...
  it('with custom debounceRendering', async function() {
    ...
    expect(mtCallbacks[0][1]).toMatchInlineSnapshot(`
      {
        "data": "{"patchList":[{"id":9,"snapshotPatch":[0,"__snapshot_a94a8_test_6",3,4,3,[{"__ltf":"__lynx_timing_actual_fmp"}],0,null,4,3,4,0,1,1,3,4,null,null,1,-2,3,null,null]}]}",
        "patchOptions": {
          "flowIds": [
            666,
          ],
  ...
  it('should work in spread', async function() {
...

    {
      ...
      expect(mtCallbacks[0][1]).toMatchInlineSnapshot(`
        {
          "data": "{"patchList":[{"id":17,"snapshotPatch":[0,"__snapshot_a94a8_test_15",3,4,3,[{"xxx":333,"__lynx_timing_flag":"__lynx_timing_actual_fmp"}],0,null,4,3,4,0,1,1,3,4,null,null,1,-2,3,null,null]}]}",
          "patchOptions": {
            "flowIds": [
              666,
            ],
