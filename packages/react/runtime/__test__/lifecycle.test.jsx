...
describe('componentDidMount', () => {
  it('basic', async function() {
    ...
    expect(mtCallback[1]).toMatchInlineSnapshot(`
      {
        "data": "{"patchList":[{"id":6,"snapshotPatch":[0,"__Card__:__snapshot_da39a_test_3",2,0,null,3,3,3,0,1,1,2,3,null,1,1,2,null]}]}",
        "patchOptions": {
          "reloadVersion": 0,
        },
      }
  ...
  it('throw', async function() {
    ...
    expect(mtCallback[1]).toMatchInlineSnapshot(`
      {
        "data": "{"patchList":[{"id":9,"snapshotPatch":[0,"__Card__:__snapshot_da39a_test_4",2,0,null,3,3,3,0,1,1,2,3,null,1,1,2,null]}]}",
        "patchOptions": {
          "reloadVersion": 0,
        },
      }
...
describe('useState', () => {
  ...
  it('basic 2', async function() {
    ...
    // update
    {
      ...
      expect(lynx.getNativeApp().callLepusMethod).toHaveBeenCalledTimes(1);
      expect(lynx.getNativeApp().callLepusMethod.mock.calls[0][1].data).toMatchInlineSnapshot(
        `"{"patchList":[{"id":27,"snapshotPatch":[0,"__Card__:__snapshot_da39a_test_15",2,4,2,[false,{"str":"str"}],1,-1,2,null]}]}"`,
      );
    }
  });
});
