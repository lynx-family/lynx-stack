...
declare global {
  ...
  declare const __BACKGROUND_ISLANDS__: boolean;
  /**
   * Emitted into the main-thread chunk's runtime by
   * `@lynx-js/react-webpack-plugin` when definitions are assembled from the
