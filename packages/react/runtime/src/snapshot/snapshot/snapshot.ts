...
export class SnapshotInstance {
  // `declare` instead of class fields: class-field semantics define every field
  // on every instance up front, and this constructor runs once per element on
  // every main-thread render.
  declare type: string;
  declare __id: number;
