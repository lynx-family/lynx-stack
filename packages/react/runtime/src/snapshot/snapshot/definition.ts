...
export interface Snapshot {
  ...
  /**
   * If present, indicates which dynamic-part index represents a "spread props"
   * object for runtime-created snapshots. This enables `setAttribute(stringKey, value)`
   * to update the underlying element via `updateSpread`.
   */
  spreadIndex?: number;
}
