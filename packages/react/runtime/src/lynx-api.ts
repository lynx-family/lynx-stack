...
export { defineMainThreadObjectType, useMainThreadObject } from './main-thread-object.js';
export type { MainThreadObjectType, MainThreadObjectTypeDefinition } from './main-thread-object.js';
