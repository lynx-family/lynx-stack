...
if (typeof lynxCoreInject !== 'undefined' && lynxCoreInject?.tt) {
  if (__DEV__) console.info('[vue-bg] setting lynxCoreInject.tt.publishEvent');
  ...
  lynxCoreInject.tt['publicComponentEvent'] = (
    ...
    if (__DEV__) console.info('[vue-bg] publicComponentEvent sign:', sign);
...
if (__DEV__) console.info('[vue-bg] globalThis.publishEvent set');
