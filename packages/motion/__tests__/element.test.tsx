...
describe('ElementCompt (unit tests)', () => {
  let mockElement: any;
  let mockSetStyleProperty: ReturnType<typeof rs.fn>;
  let mockSetStyleProperties: ReturnType<typeof rs.fn>;

  beforeEach(() => {
    mockSetStyleProperty = rs.fn();
    mockSetStyleProperties = rs.fn();
    mockElement = {
      element: { id: 'test' },
    ...
    (globalThis as any).__GetComputedStyleByKey = rs.fn(
