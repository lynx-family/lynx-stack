        ...
        try {
          ...
          if (messagesUrlAbs) {
            const buildStoredPayloadRenderUrl = (targetBaseUrl: string) => {
              ...
              r.searchParams.set('protocol', previewSource.protocol.name);
              r.searchParams.set(
                'demoUrl',
                previewSource.demoUrl ?? DEFAULT_A2UI_DEMO_URL,
              );
              r.searchParams.set('theme', previewSource.theme);
              r.searchParams.set('messagesUrl', messagesUrlAbs);
              if (actionMocksUrlAbs && previewSource.actionMocks) {
          ...
          if (speed !== 1) u.searchParams.set('speed', String(speed));
          u.searchParams.set('theme', previewSource.theme);
          if (messagesUrlAbs) {
            u.searchParams.set('messagesUrl', messagesUrlAbs);
          }
          if (actionMocksUrlAbs && previewSource.actionMocks) {
