...
import { basicFunctions } from '@lynx-js/a2ui-reactlynx/functions';
...
const CATALOG_MANIFESTS: readonly CatalogManifest[] = [
  textManifest,
  imageManifest,
  iconManifest,
  dividerManifest,
  ...
  radioGroupManifest,
  sliderManifest,
] as readonly unknown[] as readonly CatalogManifest[];
