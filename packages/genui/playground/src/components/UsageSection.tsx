      ...
      <div className='usageGrid' style={{ gridTemplateColumns: '1fr 1fr' }}>
        <div className='usageCard'>
          ...
          <pre className='codeBlock'>
            <code>{`// Import the v1.0 protocol
import { Conversation } from '@lynx-js/genui/a2ui/1.0';

export default function App() {
  return (
    <Conversation url="https://your-api-endpoint.com/v1/chat" />
  );
}`}</code>
          </pre>
        </div>
        ...
        <div className='usageCard'>
          ...
          <pre className='codeBlock'>
            <code>{`import { A2UIRender, useLynxClient } from '@lynx-js/genui/a2ui/1.0';
...
import { A2UIRender, useLynxClient } from '@lynx-js/genui/a2ui/1.0';
