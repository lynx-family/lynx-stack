...
export const LYNX_XML_DEMOS_LIST_PRESENTATION = {
  ...
  // Local callers always inject an isolated frame. Hosted callers replace
  // this method with their existing shareable render URL implementation.
  createPreviewUrl() {
    return '';
  },
