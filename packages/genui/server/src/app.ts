...
import a2uiBenchScreenshotsRoute from '../app/a2ui/bench/jobs/[jobId]/screenshots/route.js';
...
import htmlStreamRoute from '../app/html/stream/route.js';
import lynxXmlStreamRoute from '../app/lynx-xml/stream/route.js';
...
app.route('/a2ui/bench/jobs', a2uiBenchScreenshotsRoute);
...
app.route('/html/stream', htmlStreamRoute);
app.route('/lynx-xml/stream', lynxXmlStreamRoute);
