...
execSync(
  `pnpm wasm-opt ./dist/standard_bg.wasm --enable-bulk-memory-opt -O3 -o ./dist/standard_bg.wasm]`,
  { cwd: packageRoot, stdio: 'inherit' },
);
...
execSync(
  `pnpm wasm-opt ./dist/legacy_bg.wasm --enable-bulk-memory-opt -O3 -o ./dist/legacy_bg.wasm]`,
  { cwd: packageRoot, stdio: 'inherit' },
);
