...
export const mtsQueryComponentEndpoint = createRpcEndpoint<
  [string],
  LynxTemplate
>('mtsQueryComponent', false, true);

export const mtsQueryComponentTemplateEndpoint = createRpcEndpoint<
  [string, LynxTemplate],
  void
>('mtsQueryComponentTemplate', false, false);

export const btsQueryComponentEndpoint = createRpcEndpoint<
  [string, number],
  { template?: LynxTemplate; id: number; source: string }
>('btsQueryComponent', false, true);
