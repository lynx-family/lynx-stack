...
export const __wbg_get_eventinfo_event_type: (a: number, b: number) => void;
...
export const __wbg_set_eventinfo_event_handler: (a: number, b: number) => void;
...
export const mainthreadwasmcontext_create_element_common: (a: number, b: number, c: number, d: number, e: number, f: number, g: number, h: number) => number;
export const mainthreadwasmcontext_create_element_template_instance: (a: number, b: number, c: number) => void;
...
export const mainthreadwasmcontext_finish_element_template_instance: (a: number, b: number, c: number, d: number) => void;
...
export const mainthreadwasmcontext_get_element_config: (a: number, b: number, c: number) => void;
...
export const mainthreadwasmcontext_set_inline_styles_in_key_value_vec: (a: number, b: number, c: number, d: number) => void;
export const mainthreadwasmcontext_set_inline_styles_in_str: (a: number, b: number, c: number, d: number) => number;
export const mainthreadwasmcontext_set_page_element_unique_id: (a: number, b: number) => void;
export const mainthreadwasmcontext_set_typed_element_template_attribute: (a: number, b: number, c: number, d: number, e: number, f: number) => void;
export const mainthreadwasmcontext_take_timing_flags: (a: number, b: number) => void;
export const mainthreadwasmcontext_transform_element_template_style: (a: number, b: number, c: number, d: number) => void;
...
export const rule_new: (a: number, b: number, c: number) => void;
