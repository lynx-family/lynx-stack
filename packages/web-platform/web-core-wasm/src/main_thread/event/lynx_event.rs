...
// =======
//   target_element: Option<LynxElement>,
// >>>>>>> Stashed changes
// }
...
// =======
//       target_element: Some(target.clone()),
// >>>>>>> Stashed changes
//     }
//   }
// }
...
//   pub fn get_dataset(&mut self) -> wasm_bindgen::JsValue {
//     if self.dataset_js_value.is_none() {
//       let entries: js_sys::Array = js_sys::Array::from_iter(self.dataset.iter().map(|(key, value)| {
//         let value: wasm_bindgen::JsValue = value.as_js_value().clone();
//         js_sys::Array::from_iter(vec![wasm_bindgen::JsValue::from_str(key), value])
//       }));
// >>>>>>> Stashed changes
...
// =======
//   #[wasm_bindgen(getter="elementRefptr")]
//   pub fn get_element_refptr(&self) -> Option<LynxElement> {
