...
export const rawelementtemplate_create_element: (
  a: number,
  b: number,
  c: number,
  d: number,
) => void;
export const rawelementtemplate_set_attribute: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rawelementtemplate_set_dataset: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rawelementtemplate_append_child: (
  a: number,
  b: number,
  c: number,
) => void;
export const rawelementtemplate_set_cross_thread_event: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rawelementtemplate_set_attribute_slot: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rawelementtemplate_append_element_slot: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const elementtemplatesection_add_element_template: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const rawstyleinfo_append_import: (
  a: number,
  b: number,
  c: number,
) => void;
...
export const rule_push_declaration: (
  a: number,
  b: number,
  c: number,
  d: number,
...
export const selector_push_one_selector_section: (
  a: number,
  b: number,
  c: number,
  d: number,
