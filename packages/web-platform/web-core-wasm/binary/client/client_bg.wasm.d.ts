...
export const mainthreadwasmcontext___GetComponentID: (a: number, b: number) => [number, number];
export const mainthreadwasmcontext___GetElementConfig: (a: number, b: number) => any;
export const mainthreadwasmcontext___SetConfig: (a: number, b: number, c: any) => void;
export const mainthreadwasmcontext___GetConfig: (a: number, b: number) => any;
export const mainthreadwasmcontext___UpdateComponentID: (a: number, b: number, c: number, d: number) => void;
export const mainthreadwasmcontext___SetDataset: (a: number, b: number, c: any, d: any) => void;
export const mainthreadwasmcontext___AddDataset: (a: number, b: number, c: any, d: any) => void;
export const mainthreadwasmcontext___GetDataset: (a: number, b: number) => any;
export const mainthreadwasmcontext___GetDataByKey: (a: number, b: number, c: number, d: number) => any;
