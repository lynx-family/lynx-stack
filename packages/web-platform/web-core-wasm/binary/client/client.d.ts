...
export class DecodedStyleData {
  ...
  static decode_into(
    buffer: Uint8Array,
    entry_name: string | null | undefined,
...
export class MainThreadWasmContext {
  ...
  _wasm_elementFromBinary(
    parent_component_unique_id: number,
    template_url: string,
    element_template_name: string,
    element_template_section: ElementTemplateSection,
  ): Element;
  __wasm_add_event_bts(
    unique_id: number,
    event_type: string,
    event_name: string,
    event_handler_identifier?: string | null,
  ): void;
  __wasm_add_event_run_worklet(
    unique_id: number,
    event_type: string,
    event_name: string,
    event_handler_identifier?: any | null,
  ): void;
  __GetEvent(unique_id: number, event_name: string, event_type: string): any;
  __GetEvents(unique_id: number): EventInfo[];
  dispatch_event_by_path(
    bubble_unique_id_path: Uint32Array,
    event_name: string,
    is_capture: boolean,
    serialized_event: any,
  ): boolean;
  __wasm_commonEventHandler(
    event: any,
    bubble_unique_id_path: Uint32Array,
    event_name: string,
  ): void;
   ...
   */
  __wasm_AddInlineStyle_str_key(
    dom: HTMLElement,
    key: string,
    value?: string | null,
  ): void;
  __wasm_AddInlineStyle_number_key(
    dom: HTMLElement,
    key: number,
    value?: string | null,
  ): void;
  ...
  __wasm_get_unique_id_by_component_id(
    component_id: string,
  ): number | undefined;
...
export interface InitOutput {
  ...
  readonly mainthreadwasmcontext___GetComponentID: (
    a: number,
    b: number,
  ) => [number, number, number, number];
  readonly mainthreadwasmcontext___GetElementConfig: (
    a: number,
    b: number,
  ) => [number, number, number];
  readonly mainthreadwasmcontext___SetConfig: (
    a: number,
    b: number,
    c: any,
  ) => [number, number];
  readonly mainthreadwasmcontext___GetConfig: (
    a: number,
    b: number,
  ) => [number, number, number];
  readonly mainthreadwasmcontext___UpdateComponentID: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number];
  readonly mainthreadwasmcontext___SetDataset: (
    a: number,
    b: number,
    c: any,
    d: any,
  ) => [number, number];
  readonly mainthreadwasmcontext___AddDataset: (
    a: number,
    b: number,
    c: any,
    d: any,
  ) => [number, number];
  readonly mainthreadwasmcontext___GetDataset: (
    a: number,
    b: number,
  ) => [number, number, number];
  readonly mainthreadwasmcontext___GetDataByKey: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number, number];
  readonly mainthreadwasmcontext__wasm_elementFromBinary: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_add_event_bts: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_add_event_run_worklet: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___GetEvent: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___GetEvents: (
    a: number,
    b: number,
  ) => [number, number];
  readonly mainthreadwasmcontext_dispatch_event_by_path: (
    a: number,
    b: number,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_commonEventHandler: (
    a: number,
    b: any,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_set_css_id: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => void;
  readonly mainthreadwasmcontext___wasm_AddInlineStyle_str_key: (
    a: number,
    b: any,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_AddInlineStyle_number_key: (
    a: number,
    b: any,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_SetInlineStyles: (
    a: number,
    b: any,
    c: number,
    d: number,
  ...
  readonly mainthreadwasmcontext_new: (
    a: any,
    b: any,
    c: any,
    d: any,
  ...
  readonly mainthreadwasmcontext___wasm_set_page_element_unique_id: (
    a: number,
    b: number,
  ) => void;
  readonly mainthreadwasmcontext___CreateElementCommon: (
    a: number,
    b: number,
    c: any,
    d: number,
  ...
  readonly mainthreadwasmcontext___wasm_take_timing_flags: (
    a: number,
  ) => [number, number];
  readonly mainthreadwasmcontext___wasm_get_unique_id_by_component_id: (
    a: number,
    b: number,
    c: number,
  ) => number;
  readonly mainthreadwasmcontext___wasm_get_css_id_by_unique_id: (
    a: number,
    b: number,
  ) => number;
  readonly __wbg_elementtemplatesection_free: (a: number, b: number) => void;
  readonly elementtemplatesection_from_encoded: (
    a: any,
  ) => [number, number, number];
  ...
  readonly decodedstyledata_query_css_og_declarations_by_css_id: (
    a: number,
    b: number,
    c: number,
    d: number,
  ) => [number, number];
  readonly decodedstyledata_decode_into: (
    a: any,
    b: number,
    c: number,
    d: number,
