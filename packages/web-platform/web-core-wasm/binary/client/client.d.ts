...
export interface InitOutput {
  ...
  readonly mainthreadwasmcontext___GetComponentID: (a: number, b: number) => [number, number];
  readonly mainthreadwasmcontext___GetElementConfig: (a: number, b: number) => any;
  readonly mainthreadwasmcontext___SetConfig: (a: number, b: number, c: any) => void;
  readonly mainthreadwasmcontext___GetConfig: (a: number, b: number) => any;
  readonly mainthreadwasmcontext___UpdateComponentID: (a: number, b: number, c: number, d: number) => void;
  readonly mainthreadwasmcontext___SetDataset: (a: number, b: number, c: any, d: any) => void;
  readonly mainthreadwasmcontext___AddDataset: (a: number, b: number, c: any, d: any) => void;
  readonly mainthreadwasmcontext___GetDataset: (a: number, b: number) => any;
  readonly mainthreadwasmcontext___GetDataByKey: (a: number, b: number, c: number, d: number) => any;
